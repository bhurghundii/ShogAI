...
class evaluatePositions():
    ...
    def run(self):
        new_model = tf.keras.models.load_model('/home/ubuntu/Documents/Shogi-DISS/src/ml/demo/caterpillar.h5')
        new_model.summary()

        move_data = self.get_dataset('/home/ubuntu/Documents/Shogi-DISS/src/ml/demo/moveposition.csv')
